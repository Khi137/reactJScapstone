...
export default function MovieTabItemChild(props) {
  ...
  let renderMovieSchedule = () => {
    return (
      <div className="py-6">
        <h1 className="mb-6">
          <span className="bg-green-700 text-lg text-white px-1 py-1 rounded-md">
            C18
          </span>
    ...
    return (
      <div className="grid md:grid-cols-3 xl:grid-cols-3 px-3 py-6 border-b-2">
        <div className="flex items-center justify-center ">
          <div onClick={() => {
                  navigate(`/detail-movie/${props.dataPhim.maPhim}`);
                }}
            className="flex items-center justify-center w-5/6 xl:h-80 md:h-80 h-56 rounded-md overflow-hidden ">
            <img         
